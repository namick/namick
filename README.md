...
spawns. It's all on disk, and none of it is legible while it's happening. This makes it
legible, live.

**[focus-bot](https://github.com/namick/focus-bot)** — A Telegram bot that takes a
...
explain — ordinary-looking words like *being*, *substance*, and *intuition*, each
carrying an ancient or narrowly technical sense. Be-ing glosses every one of them in the margin,
...
watching the feed; agents do the maintaining, and being wrong is a real cost rather than
a failed test. It grew out of [thepsp.org](https://github.com/namick/thepsp.org), which
has been posting daily in all fifty states for years and needed the data to be right.

**[sfact.io](https://sfact.io)** — Boots a sandboxed game server from a shared save in
seconds, lets anyone walk through someone else's build, and tears the whole thing down
twenty minutes later for under a penny a session. I co-founded it and built the web
application.

### Older, still installed

**[obfuscate_id](https://github.com/namick/obfuscate_id)** — Non-obvious ActiveRecord
ids via reversible hashing. Written in 2012, still pulled in by people I've never met.
347 stars, 132 forks.

### Writing and video

[nathanamick.com/blog](https://nathanamick.com/blog) — technical writing, including a
series on custom React hooks with worked examples in
[stopwatch-timer-example](https://github.com/namick/stopwatch-timer-example) and
